...
<body class="font-sans antialiased bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-slate-100 transition-colors duration-300 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 selection:bg-indigo-500 selection:text-white relative">
    ...
    <div class="w-full max-w-md space-y-6">
        ...
        <div class="text-center">
            ...
            <p class="text-xs text-gray-600 dark:text-gray-300 mt-1.5">Selamat datang kembali! Silakan masuk ke akun Anda.</p>
        </div>
        ...
        <div class="w-full max-w-md space-y-8 bg-white dark:bg-slate-800 rounded-2xl p-8 border border-gray-200 dark:border-slate-700 shadow-2xl relative overflow-hidden transition-colors duration-300">
            ...
            <form method="POST" action="/login" class="space-y-4 relative z-10">
                ...
                <div class="space-y-1.5">
                    <label for="login_id" class="text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide">Email / No. WhatsApp</label>
                ...
                <div class="space-y-1.5">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/forgot-password" class="text-[10px] font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-305 transition">Lupa Kata Sandi?</a>
                    </div>
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="remember" name="remember" class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded focus:ring-0 focus:ring-offset-0 text-indigo-600 h-4 w-4" />
                    <label for="remember" class="ml-2 text-xs font-semibold text-gray-600 dark:text-gray-300 cursor-pointer">Ingat saya di perangkat ini</label>
                </div>
                ...
                <div class="text-center mt-4">
                    <p class="text-xs text-gray-600 dark:text-gray-300">
                        Belum punya akun? <a href="/register" class="text-blue-600 dark:text-blue-400 hover:text-blue-550 dark:hover:text-blue-300 font-semibold transition">Daftar di sini</a>
                    </p>
                </div>
            </form>
